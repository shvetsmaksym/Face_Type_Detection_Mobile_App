...
es = EarlyStopping(patience=5, min_delta=0.05, monitor="val_acc")
...
ConvNet_model.save("Models_ML/models_h5/CNN_1.h5")
ConvNet_model.save_weights("Models_ML/models_h5/CNN_1_weights.h5")
